...
object TicTacToe {
  case class X(i: Int, j: Int) extends Drawable {
    override var img: Image = ImageIO.read(new File("pic/x.png")).getScaledInstance(160, 160, Image.SCALE_SMOOTH)
    override var x: Int = i
    override var y: Int = j
  }

  case class O(i: Int, j: Int) extends Drawable {
    override var img: Image = ImageIO.read(new File("pic/o.png")).getScaledInstance(160, 160, Image.SCALE_SMOOTH)
    override var x: Int = i
    override var y: Int = j
  }
